...
public class PathMatchingResourcePatternResolver implements ResourcePatternResolver {
	...
	protected Resource[] findPathMatchingResources(String locationPattern) throws IOException {
		...
		/**
		 * 通过中的org.springframework.core.io.support.PathMatchingResourcePatternResolver#convertClassLoaderURL方法执行new UrlResource(url);
		 * 获取Resourcefile:/D:/spring/spring-framework-5.1.x/spring-code-research/out/production/classes/org/springframework/research/
		 */
